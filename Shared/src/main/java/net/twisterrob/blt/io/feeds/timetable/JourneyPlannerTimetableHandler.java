...
public class JourneyPlannerTimetableHandler extends BaseFeedHandler<JourneyPlannerTimetableFeed> {
	...
	@Override public JourneyPlannerTimetableFeed parse(InputStream is) throws IOException, SAXException {
	...
	protected void setupStopPointParsing(Element stopPoint) {
		...
		stopPoint
				.getChild(Root.NS, StopPoint.AtcoCode)
				.setEndTextElementListener(new EndTextElementListener() {
					@Override public void end(String body) {
		...
		stopPoint
				.getChild(Root.NS, Descriptor.ELEMENT)
		...
		place
				.getChild(Root.NS, Place.NptgLocalityRef)
				.setEndTextElementListener(new EndTextElementListener() {
					@Override public void end(String body) {
		...
		location
				.getChild(Root.NS, Location.Easting)
				.setEndTextElementListener(new EndTextElementListener() {
					@Override public void end(String body) {
		...
		location
				.getChild(Root.NS, Location.Northing)
				.setEndTextElementListener(new EndTextElementListener() {
					@Override public void end(String body) {
		...
		classification
				.getChild(Root.NS, StopClassification.StopType)
				.setEndTextElementListener(new EndTextElementListener() {
					@Override public void end(String body) {
	...
	protected void setupRouteLinkParsing(Element routeLink) {
		...
		routeLink
				.getChild(Root.NS, RouteLink.From.ELEMENT)
		...
		routeLink
				.getChild(Root.NS, RouteLink.To.ELEMENT)
