MIME-Version: 1.0
From: no-reply@tfl.gov.uk
To: papp.robert.s@gmail.com
X-Priority: 1
Priority: urgent
Importance: high
Date: 15 Jul 2012 21:28:42 +0100
Subject: TfL syndicated feeds account confirmation
Content-Type: text/html; charset=utf-8
Content-Transfer-Encoding: base64
Return-Path: no-reply@tfl.gov.uk
Message-ID: <THTFL-PR-WEB4eIiGXi0001274a@outbound.tfl.gov.uk>
X-OriginalArrivalTime: 15 Jul 2012 20:28:42.0944 (UTC) FILETIME=[6D3F0400:01CD62C8]

Thank you for registering for Transport for London (TfL) syndicated feeds.
...
http://jpapi.tfl.gov.uk
The JP API is IP locked. When we’ve reviewed your registration information we’ll send you an email to let you know if access is granted to the IP address you have provided.
...
Please remember that when using our syndicated feeds, it is important that you follow the guidelines in our Developer's Area and any documentation specific to each feed. You also need to comply with the relevant terms and conditions of use.